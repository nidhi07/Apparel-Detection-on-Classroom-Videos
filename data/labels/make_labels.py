...
l = ["girlsUniform","boysUniform"]
for word in l:
    os.system("convert -fill black -background white -bordercolor white -border 4 -font Ubuntu-Bold -pointsize 18 label:\"%s\" \"%s.png\""%(word, word))
